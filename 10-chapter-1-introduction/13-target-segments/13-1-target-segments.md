...
Este segmento está conformado por arrendadores de uno o múltiples inmuebles en alquiler, quienes requieren herramientas para optimizar la gestión operativa, reducir costos y mejorar la eficiencia en el mantenimiento y supervisión.

| **Aspecto** | **Detalle** |
| --- | --- |
| **Rango de edad** | 30 – 60 años |
| **Geografía**     | Principales ciudades y áreas metropolitanas del continente americano, donde el mercado de alquiler residencial y la administración de propiedades presentan una alta demanda de soluciones digitales. |
...
| **Problema**      | Tienen dificultades para identificar averías a tiempo, lo que resulta en costos elevados por mantenimientos de emergencia y pérdida de comunicación trazable con el inquilino.  |
